...
class example():
    ...
    def slide_window_search(self, binary_warped, left_current, right_current):
        ...
        for w in range(nwindows):
            ...
            cv2.moveWindow('sliding window', 100, 550)
    ...
    def camera_callback(self, data):
        ...
        cv2.moveWindow('threshold', 100, 0)
