...
class LaneDetection():
    def __init__(self):
        ...
        self.image = None
        """
        노드 초기화 및 Subscriber 선언(callback 함수)
        """
        
        
    def camera_callback(self, data):
        """
        image 메시지를 cv2로 변환하는 코드 작성
        """
    
    def color_filter(self, image):
        """
            HLS 필터 or RGB 필터 선택해 사용
    ...
    def warpping(self, image):
        """
            ...
            source, destination 위치 수정해보기
            perpective transform한 이미지 크기 정해보기
    ...
    def plothistogram(self, image):
        """
            ...
            leftbase와 rightbase 찾는 법 작성해보기
    ...
    def main(self):
        ...
        if self.image is not None: 
            ...
            # BEV wrapped img
            warpped_img, minverse = self.warpping(img)
            ...
            # 원본 이미지에 라인 넣기
            result, newwarp, color_warp, pts_left_list, pts_right_list = self.draw_lane_lines(img, thresh, minverse, draw_info)
